...
<script type="text/javascript">
      ...
      var onloadCallback = function() {
        grecaptcha.render('html_element', {
          'sitekey' : '6LcW1QsTAAAAALwfBcC1zsXjxaVZuNS5lZPLHwib',
...
<script type="text/javascript">
        function GetInputType(capt) {
var msg = "";
            var inputs = document.getElementById('captcha').value;  
             //console.log(inputs);
            if(inputs==8){
                          
                         msg = '<span style="color: rgb(131, 222, 18);">Valid Captcha.</span>';
        
                  }
             else { 
                      msg = '<span style="color: rgb(255, 27, 0);">You have entered wrong captcha. Please try again.</span>';
                }
                     captcha_info.innerHTML = msg ;
...
<span style="color:green;" id="captcha_info"></span>	
...
<div class="captcha_box">
 ...
 <label class="formRecaptcha" style="color: #ff0000;">Enter Captcha Value : 4 + 4 ? </label> 
	 
 <input type="text" id="captcha" name="captcha" value="" class="inputbox required validate-text"  onkeyup="return GetInputType(this.value);" style="width: 100%;" placeholder="Captcha"/>
    ...
    <!-- <div class="captcha_box">
		...
		<div class="k2AccountPageUpdate">
			<button class=" validate blue_btn btn btn-primary" type="submit" onclick="GetInputType(this.value);">
				<?php echo "Register"; ?>
			</button>
		</div>
	</div>
