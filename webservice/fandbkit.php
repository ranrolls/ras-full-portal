...
$introtext3 = str_replace('\r','',strip_tags($introtext2)); 
...
$query= "select * from ".$prefix."fandbstartup_fb where state = '1' order by id DESC ";   
...
$tempArray['filetype']  = $upload_fullpath.'images/'.$data['filetype'];
