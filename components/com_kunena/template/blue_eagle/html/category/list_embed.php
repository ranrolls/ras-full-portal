...
//echo "Welcome".$user->name;
 ...
 if (empty ( $this->categories [$section->id] )) { echo JText::_('COM_KUNENA_GEN_NOFORUMS');
		} else {
		$k = 0;
...
//echo '<div style="padding: 10px 0px 10px 30px; color:#224C9E !important; font-weight:bold;" >You Cannot access forum without Login. Please //Login first to view the forums.</div>';
//}
?>
</table>
